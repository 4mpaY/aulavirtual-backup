    ...
    <main>
      ...
      <section className="bg-circuit" style={{ padding: '6rem 0', background: '#fafafa', borderTop: '1px solid #eee', borderBottom: '1px solid #eee' }}>
        <div className="container-page">
          ...
          {/* Dos Grandes Líneas de Formación */}
          <div style={{ marginBottom: '4.5rem' }}>
            <div style={{ textAlign: 'center', marginBottom: '2.5rem' }} data-animate="fade-up">
              <span className="eyebrow-agenda">Propuesta Académica</span>
              <h3 style={{ fontFamily: 'Outfit, sans-serif', fontWeight: 900, fontSize: 'clamp(1.5rem, 2.5vw, 2rem)', letterSpacing: '-0.02em', marginTop: '0.75rem', color: '#1A1A1A' }}>
                Dos Grandes Líneas de Formación
              </h3>
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '2rem' }}>
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1.5rem' }}>
                  <div style={{ width: '52px', height: '52px', borderRadius: '14px', background: 'var(--agenda-accent)', color: 'var(--agenda-primary)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                    <Laptop size={26} />
                  </div>
                  <div>
                    <span style={{ fontFamily: 'Outfit, sans-serif', fontSize: '0.75rem', fontWeight: 800, color: 'var(--agenda-primary)', textTransform: 'uppercase', letterSpacing: '0.1em' }}>Línea 01</span>
                    <h4 style={{ fontFamily: 'Outfit, sans-serif', fontWeight: 900, fontSize: '1.25rem', color: '#1A1A1A', margin: 0 }}>Formación Tecnológica y Empleabilidad</h4>
                  </div>
                </div>
                <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '0.95rem', color: '#666', lineHeight: 1.6, marginBottom: '1.5rem' }}>
                  Desarrollo de habilidades prácticas orientadas al mercado laboral tecnológico, dominio de datos, programación e inteligencia artificial aplicada.
                </p>
                <div style={{ marginTop: 'auto' }}>
                  <p style={{ fontFamily: 'Outfit, sans-serif', fontSize: '0.8rem', fontWeight: 700, color: '#888', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '0.75rem' }}>Especialidades:</p>
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem' }}>
                    {['Programación', 'Bases de Datos & SQL', 'Inteligencia Artificial Aplicada', 'Herramientas Digitales', 'Empleabilidad & Marca Profesional'].map((t, idx) => (
                      <span key={idx} style={{ background: '#f8faf9', border: '1px solid #e2ebe6', color: '#333', padding: '0.4rem 0.85rem', borderRadius: '0.5rem', fontSize: '0.82rem', fontFamily: 'Inter, sans-serif', fontWeight: 500 }}>
                        {t}
                      </span>
                    ))}
                  </div>
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1.5rem' }}>
                  ...
                  <div>
                    <span style={{ fontFamily: 'Outfit, sans-serif', fontSize: '0.75rem', fontWeight: 800, color: 'var(--agenda-primary)', textTransform: 'uppercase', letterSpacing: '0.1em' }}>Línea 02</span>
                    <h4 style={{ fontFamily: 'Outfit, sans-serif', fontWeight: 900, fontSize: '1.25rem', color: '#1A1A1A', margin: 0 }}>Gerencia, Gestión Social y Desarrollo Sostenible</h4>
                  </div>
                </div>
                <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '0.95rem', color: '#666', lineHeight: 1.6, marginBottom: '1.5rem' }}>
                  Formación estratégica en relaciones comunitarias, responsabilidad social, proyectos de inversión y gestión aplicada a entornos corporativos y mineros.
                </p>
                <div style={{ marginTop: 'auto' }}>
                  <p style={{ fontFamily: 'Outfit, sans-serif', fontSize: '0.8rem', fontWeight: 700, color: '#888', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '0.75rem' }}>Especialidades:</p>
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem' }}>
                    {['Gerencia e Inversión Social', 'Relaciones Comunitarias', 'Responsabilidad Social Empresarial', 'Proyectos de Inversión', 'Gestión en Minería y Empresas'].map((t, idx) => (
                      <span key={idx} style={{ background: '#f8faf9', border: '1px solid #e2ebe6', color: '#333', padding: '0.4rem 0.85rem', borderRadius: '0.5rem', fontSize: '0.82rem', fontFamily: 'Inter, sans-serif', fontWeight: 500 }}>
                        {t}
                      </span>
                    ))}
