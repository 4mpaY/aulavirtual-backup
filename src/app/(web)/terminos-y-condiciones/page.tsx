...
export const metadata = {
  title: 'Términos y Condiciones | Terramett S.A.C',
}
      ...
      <Container maxWidth="md">
        ...
        <Box sx={{ '& h4': { color: 'var(--web-dark, #025E44)', fontWeight: 800, mt: 5, mb: 2 }, '& p': { mb: 2, lineHeight: 1.8 } }}>
          ...
          <Typography paragraph>
            Bienvenido a <strong>Terramett S.A.C</strong> (&quot;Nosotros&quot;, &quot;Terramett&quot;).
          ...
          <Typography paragraph>
            Terramett S.A.C brinda servicios de capacitación, consultoría técnica y soluciones de ingeniería integral.
            Nuestra Aula Virtual contiene cursos y certificaciones dirigidos a profesionales de la ingeniería y topografía.
          ...
          <Typography paragraph>
            ...
            pertenece originariamente a Terramett S.A.C o a sus instructores afiliados.
          ...
          <Typography paragraph>
            ...
            indicados en cada curso (visualización al 100%, aprobación de evaluaciones, etc.). Terramett se reserva
          ...
          <Typography paragraph>
            ...
            del registro (Ley de Protección de Datos Personales en territorio Peruano).
          ...
          <Typography paragraph>
            Para consultas de soporte, envíe sus requerimientos a <strong>diego.utrilla@terramett.pe</strong>.
