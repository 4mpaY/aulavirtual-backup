...
export const metadata = {
  title: 'Términos y Condiciones | Agenda 2050',
}
      ...
      <Container maxWidth="md">
        ...
        <Box sx={{ '& h4': { color: 'var(--web-dark, #025E44)', fontWeight: 800, mt: 5, mb: 2 }, '& p': { mb: 2, lineHeight: 1.8 } }}>
          ...
          <Typography paragraph>
            Bienvenido a <strong>AGENDA 2050 PERÚ</strong> (&quot;Nosotros&quot;, &quot;Agenda&quot;).
          ...
          <Typography paragraph>
            Agenda 2050 brinda servicios de capacitación y entrenamiento virtual.
          ...
          <Typography paragraph>
            Todos los pagos procesados en nuestro sitio web se gestionan a través de pasarelas de pago seguras (como Culqi, IziPay, PayPal o Mercado Pago).
          ...
          <Typography paragraph>
            ...
            pertenece originariamente a AGENDA 2050 PERÚ o a sus instructores afiliados.
          ...
          <Typography paragraph>
            ...
            indicados en cada curso (visualización al 100%, aprobación de evaluaciones, etc.). Agenda 2050 se reserva
          ...
          <Typography paragraph>
            Nos compromemos a mantener la confidencialidad de la información proporcionada por los usuarios en el momento
          ...
          <Typography paragraph>
            Para consultas de soporte, envíe sus requerimientos a <strong>agenda2050peru@gmail.com</strong>.
