...
export const metadata = {
  title: 'Política de Cambios y Devoluciones | Visiona Perú',
}
      ...
      <Container maxWidth="md">
        ...
        <Box sx={{ '& h4': { color: 'var(--web-dark, #025E44)', fontWeight: 800, mt: 5, mb: 2 }, '& p': { mb: 2, lineHeight: 1.8 } }}>
          ...
          <Typography paragraph>
            ...
            servicios educativos ofrecidos por <strong>Visiona Perú Safety Solutions S.A.C</strong>,
            con RUC <strong>20611944579</strong>, con domicilio en Las Brenias 116 - Chorrillos — a través de su Aula Virtual. Al adquirir cualquier curso,
          ...
          <Typography paragraph>
            1. Enviar un correo a <strong>confiabilidad@visionaperu.com</strong> con el asunto:{' '}
          ...
          <Typography paragraph>
            ...
            <strong>confiabilidad@visionaperu.com</strong>. De acuerdo con la legislación de protección
