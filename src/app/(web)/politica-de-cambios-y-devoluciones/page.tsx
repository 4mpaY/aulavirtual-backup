...
export const metadata = {
  title: 'Política de Cambios y Devoluciones | Agenda 2050',
}
      ...
      <Container maxWidth="md">
        ...
        <Box sx={{ '& h4': { color: 'var(--web-dark, #025E44)', fontWeight: 800, mt: 5, mb: 2 }, '& p': { mb: 2, lineHeight: 1.8 } }}>
          ...
          <Typography paragraph>
            ...
            servicios educativos ofrecidos por <strong>AGENDA 2050 PERÚ</strong>,
            con RUC <strong>20602211721</strong>, con domicilio en Lima, Perú — a través de su Aula Virtual. Al adquirir cualquier curso,
          ...
          <Typography paragraph>
            1. Enviar un correo a <strong>agenda2050peru@gmail.com</strong> con el asunto:{' '}
          ...
          <Typography paragraph>
            AGENDA 2050 PERÚ se reserva el derecho de descontar las comisiones operativas
          ...
          <Typography paragraph>
            ...
            <strong>agenda2050peru@gmail.com</strong>. De acuerdo con la legislación de protección
