...
export const metadata = {
  title: 'Política de Cambios y Devoluciones | Terramett S.A.C',
}
      ...
      <Container maxWidth="md">
        ...
        <Box sx={{ '& h4': { color: 'var(--web-dark, #025E44)', fontWeight: 800, mt: 5, mb: 2 }, '& p': { mb: 2, lineHeight: 1.8 } }}>
          ...
          <Typography paragraph>
            ...
            servicios educativos ofrecidos por <strong>Terramett S.A.C</strong>,
            con RUC <strong>20613057791</strong>, con domicilio en Lima, Perú — a través de su Aula Virtual. Al adquirir cualquier curso,
          ...
          <Typography paragraph>
            1. Enviar un correo a <strong>diego.utrilla@terramett.pe</strong> con el asunto:{' '}
          ...
          <Typography paragraph>
            Terramett S.A.C se reserva el derecho de descontar las comisiones operativas
          ...
          <Typography paragraph>
            ...
            <strong>diego.utrilla@terramett.pe</strong>. De acuerdo con la legislación de protección
