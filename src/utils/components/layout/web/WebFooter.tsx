...
const staticSocialLinks = [
  { label: 'Facebook', href: 'https://www.facebook.com/proqall', icon: <Facebook size={20} /> },
  { label: 'Youtube', href: 'https://www.youtube.com/@PROQALLCCE', icon: <Youtube size={20} /> },
  { label: 'Instagram', href: 'https://www.instagram.com/proqall.cce/?hl=es', icon: <Instagram size={20} /> },
]
...
const WebFooter = async ({ platformName = 'Aula Virtual' }: WebFooterProps) => {
  ...
  const waNumber = configs.WHATSAPP_NUMERO || '51977703661'
          ...
          <div>
            ...
            <ul className="space-y-3" style={{ opacity: 0.8 }}>
              <li className="flex items-start gap-2" style={{ fontFamily: 'Poppins, sans-serif', fontSize: '0.875rem' }}>
                ...
                <span>+51 977703661</span>
              </li>
              <li className="flex items-start gap-2" style={{ fontFamily: 'Poppins, sans-serif', fontSize: '0.875rem' }}>
                <Mail size={16} className="flex-shrink-0 mt-0.5" />
                <span>Proqall.cce@gmail.com</span>
              </li>
              <li className="flex items-start gap-2" style={{ fontFamily: 'Poppins, sans-serif', fontSize: '0.875rem' }}>
                <MapPin size={16} className="flex-shrink-0 mt-0.5" />
                <span>Jr. San Gregorio - San Carlos, Huancayo</span>
              </li>
            </ul>
          </div>
